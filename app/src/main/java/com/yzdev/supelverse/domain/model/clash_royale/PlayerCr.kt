package com.yzdev.supelverse.domain.model.clash_royale
...
import com.yzdev.supelverse.data.remote.dto.clash_royale.PlayerCrDto
...
fun PlayerCrDto.toPlayerCr(): PlayerCr{
    return PlayerCr(
        achievements = achievements.toPlayerCrAchievements(),
        arena = arena.toPlayerCrArena(),

    )
}

/** Cast achievements ******************************************************************/
private fun List<PlayerCrDto.Achievement>.toPlayerCrAchievements(): List<PlayerCr.Achievement>{
    return this.map {
        PlayerCr.Achievement(
...
/** Cast Arena *********************************************************************************************/
private fun PlayerCrDto.Arena.toPlayerCrArena(): PlayerCr.Arena{
    return PlayerCr.Arena(
        name = name,
        id = id
    )
}
